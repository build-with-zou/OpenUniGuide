<!-- 文件路径：data/Asia/Singapore/National_University_of_Singapore/_labs/Green_Energy_Management_and_Smart_Grid_Research_Center.md -->
...
- **所属院系**： Department of Electrical and Computer Engineering, College of Design and Engineering
- **实验室/中心名称**： Green Energy Management and Smart Grid Research Center (GEMS)
- **主页链接**： https://cde.nus.edu.sg/ece/research/research-centers/gems/

## 研究方向

- **方向 1**： Smart grid research
- **方向 2**： Energy management and optimization systems
- **方向 3**： High-performance power electronic converters
- **方向 4**： Demand management
- **方向 5**： Power quality control
