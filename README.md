...
└── data/
    ...
    └── North_America/
        └── USA/
            ...
            │   ├── MSc_Computational_Science_and_Engineering.md
            │   ├── PhD_Brain_and_Cognitive_Sciences.md
            │   ├── PhD_Computational_Science_and_Engineering.md
            │   ├── PhD_Electrical_Engineering_and_Computer_Science.md
            │   └── PhD_Interdisciplinary_Computational_Science_and_Engineering.md
            └── Stanford_University/
                ├── _labs/
                │   ├── README.md
